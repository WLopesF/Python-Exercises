...
if(string4 == "Sim || Sou"):
   string5 = input("Em qual ano ou faculdade e universidade?")
   print("Olá, o seu nome é", string1, "seu sobrenome é", string2, "e você tem", string3, "anos de idade. Você é estudante do/de na", string5." 
   else:
